...
describe("detectPlatform", () => {
  ...
  it("returns a valid platform as default when no env vars are set", () => {
    ...
    const signal = detectPlatform();
    expect(["claude-code", "gemini-cli", "codex", "cursor", "opencode", "kilo", "openclaw", "vscode-copilot", "copilot-cli", "antigravity", "antigravity-cli", "kiro", "pi", "omp", "zed", "qwen-code", "codebuddy", "jetbrains-copilot", "kimi"]).toContain(signal.platform);
  });
});
